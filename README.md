...
```bash
$ curl -sOL https://github.com/BurntSushi/xsv/releases/download/0.8.9/xsv-0.8.9-x86_64-unknown-linux-gnu.tar.gz
$ tar xf xsv-0.8.9-x86_64-unknown-linux-gnu.tar.gz
$ cd xsv-0.8.9-x86_64-unknown-linux-gnu/
$ ./xsv --version
0.8.9
```
